...
# Criando janela
janela = tk.Tk()
janela.title("Aplicativo de Tarefas")
...
def adicionar_item_tarefa(tarefa):
    ...
    label_tarefa.pack(side=tk.LEFT, fill=tk.X, padx=3, pady=5)
    ...
    check_button = tk.Checkbutton(frame_tarefa, command=lambda label = label_tarefa: alterar_sublinhado(label))
...
icon_editar = PhotoImage(file="editar.png").subsample(7,7)
icon_deletar = PhotoImage(file="deletar.png").subsample(7,7)
